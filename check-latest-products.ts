...
async function checkLatestProducts() {
  // Latest query: "dresses for curvy women that pair well with Dr. Martens high top chelsea shoes"
  const productIds = [
    '8217306366137', // Teddi Lace-Trimmed Mini Dress for Women in Grey Melange
    '8179608846521', // Florencio Tweed Mini Dress for Women in Cream
    '8193121747129', // Rialto Sequin Maxi Dress for Women in Bordeaux
    '8244345471161'  // Sarajane Sequin Stretch Knit Mini Dress for Women in Black
  ];
  ...
  console.log('='.repeat(80));
  console.log(`\nQuery: "dresses for curvy women that pair well with Dr. Martens high top chelsea shoes"`);
  console.log(`\nGenerated Constraints:`);
  console.log(`  Styles: ${constraints.styles.join(', ')} (intent: strong)`);
  console.log(`  Fits: ${constraints.fits.join(', ')} (intent: strong)`);
  console.log(`  Age Groups: ${constraints.ageGroups.join(', ')} (intent: required)`);
  console.log('\n' + '='.repeat(80) + '\n');
