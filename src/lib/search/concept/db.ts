...
export async function searchConceptIndexFromDB(
  ...
  try {
    ...
    const attributePaths = [
      { key: 'styles', path: 'attributes->\'Style\'' },
      { key: 'occasions', path: 'attributes->\'Occasion\'' },
      { key: 'patterns', path: 'attributes->\'Pattern\'' },
      { key: 'materials', path: 'attributes->\'Material\'' },
      { key: 'collections', path: 'attributes->\'Collection\'' },
      { key: 'lengths', path: 'attributes->\'Length\'' },
      { key: 'necklines', path: 'attributes->\'Neckline\'' },
      { key: 'sleeveLengths', path: 'attributes->\'Sleeve Length\'' },
      { key: 'embellishments', path: 'attributes->\'Embellishment\'' },
      { key: 'fits', path: 'attributes->\'Fit\'' },
    ];

    const constraintConditions: string[] = [];

    for (const { key, path } of attributePaths) {
