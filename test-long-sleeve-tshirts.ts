...
async function testLongSleeveTshirts() {
  console.log('='.repeat(80));
  console.log('Testing: "I want long sleeve tshirts"');
  console.log('='.repeat(80));
  console.log();

  const query = "I want long sleeve tshirts";
  ...
  try {
    const result = await handleLoveshackfancyQuery({
      message: query,
      sessionId: 'test-session-long-sleeve-tshirts',
