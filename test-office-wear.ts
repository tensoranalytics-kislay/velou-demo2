...
async function testOfficeWearQuery() {
  console.log('='.repeat(80));
  console.log('Testing: "I am joining office next month, suggest me something to wear"');
  console.log('='.repeat(80));
  console.log();

  const query = "I am joining office next month, suggest me something to wear";
  ...
  try {
    const result = await handleLoveshackfancyQuery({
      message: query,
      sessionId: 'test-session-office-wear',
